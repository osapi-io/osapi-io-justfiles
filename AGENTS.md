...
— all of which apply to agents exactly as they apply to people. This file
...
A change that alters how modules are structured, consumed, or named is a
change to that specification first, and to this repository second.

## A shared recipe cannot be tested here

Every repository in the organization fetches these files from `main`. Nothing
in this repository exercises a recipe end to end, so "it looks right" is not
